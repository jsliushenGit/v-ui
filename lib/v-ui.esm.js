      ...
      ripple: {
        bind(t, {
          ...
          t.addEventListener("click", (function (e) {
            var n = t.getElementsByClassName("waves-animation")[0];
            n.style.left = e.offsetX - n.clientWidth / 2 + "px", n.style.top = e.offsetY - n.clientHeight / 2 + "px"
          }))
        }
      }
    },
...
export default s;
export {
  t as Button, n as Input, e as Tag
};